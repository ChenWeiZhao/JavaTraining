package cwz.study.jvmclassloader;
...
public class JvmclassloaderApplication extends ClassLoader {
    ...
    public static void main(String[] args) throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, InstantiationException, ClassNotFoundException {
        //SpringApplication.run(JvmclassloaderApplication.class, args);
        // 相关参数
        final String className = "Hello";
        final String methodName = "hello";
        // 创建类加载器
        ClassLoader classLoader = new JvmclassloaderApplication();
        // 加载相应的类
